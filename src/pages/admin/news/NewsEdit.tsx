...
const NewsEdit = () => {
        ...
        const fetchNews = async () => {
            try {
                ...
                setFormData({
                    ...
                    thumbnail: data.thumbnail || "", // Assuming backend returns full URL or path
                    thumbnailFile: null,
                    tags: [], // Tags not in model yet, default empty
                    scheduledDate: "", // Not handling scheduled date from backend yet unless field exists
                });
            } catch (error) {
    ...
    const handleSave = async (publishStatus?: "Draft" | "Published" | "Scheduled") => {
        ...
        try {
            ...
            submitData.append("excerpt", formData.subtitle || "");
            ...
            await api.patch(`/education/articles/${id}/`, submitData, {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Perbarui konten berita "{formData.title}"
                        </p>
                    </div>
                </div>
                    ...
                    <Card>
                        <CardContent className="p-6">
                            ...
                            <ThumbnailUpload
                                ...
                                onChange={(url, file) =>
                                    setFormData({ ...formData, thumbnail: url, thumbnailFile: file || null })
                                }
                            />
                        </CardContent>
                    </Card>
