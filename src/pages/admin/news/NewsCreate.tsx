...
const NewsCreate = () => {
    ...
    const handleSave = async (publishStatus?: "Draft" | "Published" | "Scheduled") => {
        ...
        try {
            ...
            submitData.append("excerpt", formData.subtitle || ""); // Map subtitle to excerpt
            ...
            await api.post("/education/articles/", submitData, {
            ...
            let errorMessage = "Gagal membuat berita";
            if (error.response?.data) {
                // Try to extract specific error message
                const data = error.response.data;
                if (typeof data === 'object') {
                    // Start with first error found
